                                    ...
                                    <div class="opts">
                                        @if($p->deleted_at == NULL)
                                            ...
                                            @if(kvfj(Auth::user()->permissions, 'patient_delete'))                                            
                                                <a href="#" data-action="borrar" data-path="admin/paciente" data-object="{{ $p->id }}" class="btn-deleted" data-toogle="tooltrip" data-placement="top" title="Borrar" ><i class="fas fa-trash"></i></a>    
                                            @endif
                                        @else
                                            @if(kvfj(Auth::user()->permissions, 'patient_restore'))   
                                                <a href="{{ url('/admin/paciente/'.$p->id.'/restablecer') }}" data-toogle="tooltrip" data-placement="top" title="Restaurar Paciente"><i class="fas fa-trash-arrow-up"></i></a>                                         
